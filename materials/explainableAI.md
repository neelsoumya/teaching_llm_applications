...
## 🎥 Practical: Mechanistic explainability for understanding if a model has goals

- 🤔 Can a model have goals?

- Open a Google Colab notebook for running the code below and switch (using Runtime) to a T4 GPU

- [code](../practicals/mechanistic_interp.py)
...
- [🎮 code](https://github.com/ayyucekizrak/Mechanistic-Interpretability)
